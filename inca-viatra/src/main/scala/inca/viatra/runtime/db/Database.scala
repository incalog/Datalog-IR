...
import inca.viatra.runtime.Query.ChangeFeed
import inca.viatra.runtime.context.DataModel.Link
import inca.viatra.runtime.index.*
import inca.viatra.runtime.index.MetaElements.PrimitiveValue
import inca.viatra.runtime.context.DataModel
import inca.viatra.runtime.db.updater.{DatabaseUpdater, DirectDatabaseUpdater}
import inca.viatra.runtime.index.{BagIndex, DynamicKey, Index, LinkListFirstKey, LinkListNextKey, LinkNodeKey, LinkPrimitiveKey, NamedRelationKey, NodeTypeKey, PrimitiveTypeKey, VirtualKey}
import inca.viatra.runtime.index.binary.{BidirectionalManyToOneIndex, BidirectionalOneToOneIndex}
import inca.viatra.runtime.index.dynamic.{DynamicIndex, DynamicIndexFactory}
import inca.viatra.runtime.index.unary.{UnaryBagIndex, UnarySetIndex}
import inca.viatra.runtime.index.virtual.VirtualIndex
