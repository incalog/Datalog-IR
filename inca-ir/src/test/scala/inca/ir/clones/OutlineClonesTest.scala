...
//
//  override val config: ConfigVNOld = ConfigVNOld(simplifyArithmetic=true, outline=true)
//
...
//        ))
//      ))
//    performTest(expected, input, ConfigVNOld(simplifyArithmetic=true, outline=true, attemptAlphaEquivalence=true))
//  }
