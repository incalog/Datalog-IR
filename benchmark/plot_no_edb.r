...
plot(data.matrix(pathDatalogEDBRight),
     ...
     xaxt = "n",
     ylim = c(0, 15), # TODO change regarding upper bound of measurevalues
     lwd = 1.5
)
...
plot(data.matrix(pathDatalogEDBLeft),
     ...
     xlab = "Number of nodes",
     xaxt = "n",
     ylim = c(0, 40), # TODO change regarding upper bound of measurevalues
     lwd = 1.5
)
...
plot(data.matrix(pathDatalogHeapRight),
     ...
     xlab = "Heap size",
     xaxt = "n",
     ylim = c(0, 25), # TODO change regarding upper bound of measurevalues
     lwd = 1.5
)
