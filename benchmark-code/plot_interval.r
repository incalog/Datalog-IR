...
asgDL <- colMeans(readTime("Interval_DL.csv"))
#asgMono <- colMeans(readTime("Interval_Mono.csv"))
asgMonoOpt <- colMeans(readTime("Interval_Mono_opt.csv"))
