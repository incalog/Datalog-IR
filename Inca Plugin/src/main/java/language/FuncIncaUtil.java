...
public class FuncIncaUtil {
    /*
    * finds all Psi nodes named "name"*/
    public static List<PsiNamedElement> findDefinitionNode(@NotNull Project project, @Nullable FuncIncaFile f, @Nullable String name){
