...
public class FunIncAConstructorTypeImpl extends ASTWrapperPsiElement implements FunIncAConstructorType {

  public FunIncAConstructorTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public FunIncATypeNameRef getTypeNameRef() {
    return findNotNullChildByClass(FunIncATypeNameRef.class);
  }
