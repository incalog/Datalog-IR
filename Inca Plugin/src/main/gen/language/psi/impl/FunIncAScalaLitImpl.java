...
public class FunIncAScalaLitImpl extends ASTWrapperPsiElement implements FunIncAScalaLit {

  public FunIncAScalaLitImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FunIncAVisitor visitor) {
    visitor.visitScalaLit(this);
  }
