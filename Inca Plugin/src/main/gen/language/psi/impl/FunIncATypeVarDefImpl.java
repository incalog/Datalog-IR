...
public class FunIncATypeVarDefImpl extends FunIncADeclImpl implements FunIncATypeVarDef {

  public FunIncATypeVarDefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FunIncAVisitor visitor) {
    visitor.visitTypeVarDef(this);
  }
