...
public class FunIncASetComprehensionExpImpl extends FunIncAExpImpl implements FunIncASetComprehensionExp {

  public FunIncASetComprehensionExpImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull FunIncAVisitor visitor) {
    visitor.visitSetComprehensionExp(this);
  }
