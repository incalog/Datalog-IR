...
public class FuncIncaOptionExpImpl extends ASTWrapperPsiElement implements FuncIncaOptionExp {

  public FuncIncaOptionExpImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FuncIncaVisitor visitor) {
    visitor.visitOptionExp(this);
  }
