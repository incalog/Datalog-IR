...
public class FuncIncaTypeAnnotationImpl extends ASTWrapperPsiElement implements FuncIncaTypeAnnotation {

  public FuncIncaTypeAnnotationImpl(@NotNull ASTNode node) {
    super(node);
  }
