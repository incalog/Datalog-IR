...
public class FunIncAPrimitiveTypeImpl extends ASTWrapperPsiElement implements FunIncAPrimitiveType {

  public FunIncAPrimitiveTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
