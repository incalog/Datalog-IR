...
public class FuncIncaConsIdImpl extends ASTWrapperPsiElement implements FuncIncaConsId {

  public FuncIncaConsIdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FuncIncaVisitor visitor) {
    visitor.visitConsId(this);
  }
