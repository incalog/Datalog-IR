...
public class FunIncAMatchCaseImpl extends ASTWrapperPsiElement implements FunIncAMatchCase {

  public FunIncAMatchCaseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public FunIncAPat getPat() {
    return findChildByClass(FunIncAPat.class);
  }
