...
public class FunIncADataDefImpl extends FunIncADeclImpl implements FunIncADataDef {

  public FunIncADataDefImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<FunIncADataConstructorDef> getDataConstructorDefList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, FunIncADataConstructorDef.class);
  }
