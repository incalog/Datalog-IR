...
public class FunIncATypeNameRefImpl extends ASTWrapperPsiElement implements FunIncATypeNameRef {

  public FunIncATypeNameRefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FunIncAVisitor visitor) {
    visitor.visitTypeNameRef(this);
  }
