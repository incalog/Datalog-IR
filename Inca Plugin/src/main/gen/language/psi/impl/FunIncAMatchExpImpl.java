...
public class FunIncAMatchExpImpl extends FunIncAExpImpl implements FunIncAMatchExp {

  public FunIncAMatchExpImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<FunIncAMatchCase> getMatchCaseList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, FunIncAMatchCase.class);
  }
