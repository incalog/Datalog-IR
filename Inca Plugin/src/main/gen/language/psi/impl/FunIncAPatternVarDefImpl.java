...
public class FunIncAPatternVarDefImpl extends FunIncADeclImpl implements FunIncAPatternVarDef {

  public FunIncAPatternVarDefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FunIncAVisitor visitor) {
    visitor.visitPatternVarDef(this);
  }
