...
public class FuncIncaConstrImpl extends ASTWrapperPsiElement implements FuncIncaConstr {

  public FuncIncaConstrImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public FuncIncaVar getVar() {
    return findNotNullChildByClass(FuncIncaVar.class);
  }
