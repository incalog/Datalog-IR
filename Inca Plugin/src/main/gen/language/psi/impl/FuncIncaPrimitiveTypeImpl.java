...
public class FuncIncaPrimitiveTypeImpl extends ASTWrapperPsiElement implements FuncIncaPrimitiveType {

  public FuncIncaPrimitiveTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
