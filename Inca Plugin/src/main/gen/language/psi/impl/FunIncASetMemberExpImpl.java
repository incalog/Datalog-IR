...
public class FunIncASetMemberExpImpl extends FunIncAExpImpl implements FunIncASetMemberExp {

  public FunIncASetMemberExpImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull FunIncAVisitor visitor) {
    visitor.visitSetMemberExp(this);
  }
