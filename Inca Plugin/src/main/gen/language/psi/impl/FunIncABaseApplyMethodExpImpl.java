...
public class FunIncABaseApplyMethodExpImpl extends FunIncAExpImpl implements FunIncABaseApplyMethodExp {

  public FunIncABaseApplyMethodExpImpl(@NotNull ASTNode node) {
    super(node);
  }
