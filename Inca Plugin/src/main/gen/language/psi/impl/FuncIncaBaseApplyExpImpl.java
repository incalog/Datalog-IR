...
public class FuncIncaBaseApplyExpImpl extends ASTWrapperPsiElement implements FuncIncaBaseApplyExp {

  public FuncIncaBaseApplyExpImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FuncIncaVisitor visitor) {
    visitor.visitBaseApplyExp(this);
  }
