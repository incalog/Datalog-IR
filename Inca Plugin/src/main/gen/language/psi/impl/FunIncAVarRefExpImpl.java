...
public class FunIncAVarRefExpImpl extends FunIncANamedVariableImpl implements FunIncAVarRefExp {

  public FunIncAVarRefExpImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FunIncAVisitor visitor) {
    visitor.visitVarRefExp(this);
  }
