...
public interface TreeSitterTruediffLibrary extends Library {
     ...
     */
    String ts_language_field_name_for_id(TSLanguage language, short id);
     ...
     */
    void ts_literal_map_add_unnamed_token(TSLiteralMap lit_map, short id);
     ...
     * The two trees must be initialized!
     */
    TSDiffResult.ByValue ts_compare_to_print_graph(TSTree fst_tree, TSTree snd_tree, String fst_str, String snd_str, TSLiteralMap lit_map, FILE file);

    void ts_tree_diff_graph(TSNode.ByValue fst_node, TSLanguage lang, FILE file);
