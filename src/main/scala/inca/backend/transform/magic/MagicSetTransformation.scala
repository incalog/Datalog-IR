...
//      if (pat.hasHint(MagicSetHints.AdornmentsKey)) {
...
//      shouldInsertInput(pat) && pat.hasHint(MagicSetHints.AdornmentsKey)
//
...
//      }
//
//      val adornment = pat.hints(MagicSetHints.AdornmentsKey) match {
//        case MagicSetHints.Adornments(adorn) => adorn.head
