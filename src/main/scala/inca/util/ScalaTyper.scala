...
trait ScalaTyper {
  ...
  protected var importBoundNames: mutable.ListBuffer[String] = mutable.ListBuffer()

  // remember which names are top-level definitions
  protected var toplevelBoundNames: mutable.ListBuffer[String] = mutable.ListBuffer()
