...
object PathIRModule {
  ...
  def moduleWithCycleInputComputation(recursive: String): CompiledModule = new CompiledModule {
    override val options: Options = new Options {
      override def optimizations: Seq[Optimization] = Seq()
      override def transformations: Seq[Transformation] = Seq(DeriveDemandPatterns, DemandTransformation)
      override def stopOnError: Boolean = true
    ...
    override def ir: Datalog.Module = Datalog.Module("Path", Seq(), Seq(
      ...
      Datalog.Pattern(None, "fullyConnect",
        Seq(
          Datalog.Param("current", Datalog.TScalaInt),
          Datalog.Param("startNode", Datalog.TScalaInt),
          Datalog.Param("endNode", Datalog.TScalaInt),
          Datalog.Param("out$1", Datalog.TScalaInt),
          Datalog.Param("out$2", Datalog.TScalaInt)
        ),
        Seq(
          Datalog.Body(
            Seq(
              Datalog.Computed(Datalog.True, Datalog.Evaluation(
                Seq(Datalog.Var("current") -> Datalog.TScalaInt, Datalog.Var("endNode") -> Datalog.TScalaInt),
                Datalog.TScalaBoolean,
                Scala(q"(c: Int, e: Int) =>  e > c")
              )),
              Datalog.Computed(Datalog.Var("endNode$1"), Datalog.Evaluation(
                Seq(Datalog.Var("endNode") -> Datalog.TScalaInt),
                Datalog.TScalaInt,
                Scala(q"(i: Int) => i - 1")
              )),
              Datalog.Call("fullConnect", Seq(Datalog.Var("current"), Datalog.Var("startNode"), Datalog.Var("endNode$1"), Datalog.Var("out$1"), Datalog.Var("out$2")))
            )
          ),
          Datalog.Body(Seq(
            Datalog.Eq(Datalog.Var("out$1"), Datalog.Var("current")),
            Datalog.Eq(Datalog.Var("out$2"), Datalog.Var("endNode"))
          ))
        )
      ),
      Datalog.Pattern(None, "cycles",
        Seq(
          Datalog.Param("current", Datalog.TScalaInt),
          ...
          Datalog.Body(
            Seq(
              Datalog.Computed(Datalog.True, Datalog.Evaluation(
                Seq(Datalog.Var("current") -> Datalog.TScalaInt, Datalog.Var("endNode") -> Datalog.TScalaInt),
                Datalog.TScalaBoolean,
                Scala(q"(c: Int, e: Int) =>  c < e")
              )),
              Datalog.Computed(Datalog.Var("current$1"), Datalog.Evaluation(
                Seq(Datalog.Var("current") -> Datalog.TScalaInt, Datalog.Var("step") -> Datalog.TScalaInt),
                Datalog.TScalaInt,
                Scala(q"(c: Int, s: Int) => c + s")
              )),
              Datalog.Call("cycles", Seq(Datalog.Var("current$1"), Datalog.Var("step"), Datalog.Var("startNode"), Datalog.Var("endNode"), Datalog.Var("out$1"), Datalog.Var("out$2")))
            )
          ),
          Datalog.Body(
            Seq(
              ...
              Datalog.Call("fullyConnect", Seq(Datalog.Var("current"), Datalog.Var("startNode"), Datalog.Var("endNode"), Datalog.Var("out$1"), Datalog.Var("out$2")))
            )
          ),
          Datalog.Body(
            Seq(
              ...
              Datalog.Call("line", Seq(Datalog.Var("startNode"), Datalog.Var("endNode"), Datalog.Var("out$1"), Datalog.Var("out$2")))
            )
          ),
          Datalog.Body(
            Seq(
      ...
      Datalog.Pattern(None, "edge",
        ...
        Seq(
          Datalog.Body(
            Seq(
              Datalog.Call("cycles", Seq(Datalog.IntConstant(1), Datalog.Var("step"), Datalog.IntConstant(1), Datalog.Var("endNode"), Datalog.Var("x"), Datalog.Var("y")))
            )
          ),
        )
      ),
