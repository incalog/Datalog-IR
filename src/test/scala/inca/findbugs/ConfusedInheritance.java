...
import inca.analyzedLangs.ClassDeclaration;
import inca.analyzedLangs.FieldDeclaration;
...
public final class ConfusedInheritance extends TFQuerySpecification {
    ...
    private static final class GeneratedPQuery extends BasePQuery {
        ...
        private final PParameter p_class = new PParameter("class",
                ...
                new InputKey.NodeTypeKey(new MetaElements.NodeType(ClassDeclaration.class.getCanonicalName())));
        ...
        protected Set<PBody> doGetContainedBodies() throws QueryInitializationException {
...

            {
                ...
                new TypeConstraint(body, Tuples.staticArityFlatTupleOf(var_class, var__tmp_1),
                        new InputKey.LinkKey(new MetaElements.NodeType(ClassDeclaration.class.getCanonicalName()).apply("isFinal")));
                ...
                new TypeConstraint(body, Tuples.staticArityFlatTupleOf(var_class, var__tmp_3),
                        new InputKey.LinkKey(new MetaElements.NodeType(ClassDeclaration.class.getCanonicalName()).apply("members")));
                new Equality(body, var__member, var__tmp_3);

                new TypeConstraint(body, Tuples.flatTupleOf(var__member),
                        new InputKey.NodeTypeKey(new MetaElements.NodeType(FieldDeclaration.class.getCanonicalName())));
                new TypeConstraint(body, Tuples.staticArityFlatTupleOf(var__member, var__tmp_4),
                        new InputKey.LinkKey(new MetaElements.NodeType(FieldDeclaration.class.getCanonicalName()).apply("visibility")));
                new TypeConstraint(body, Tuples.flatTupleOf(var__tmp_4),
                        new InputKey.NodeTypeKey(new MetaElements.NodeType(ProtectedVisibility.class.getCanonicalName())));
