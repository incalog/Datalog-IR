...
//      Datalog.TScalaInt, Scala(q"(left: Int, right: Int) => left + right"))),
//    Datalog.Eq(Datalog.Var("out"), Datalog.Var("eval"))
//  )))).addHint(MagicSetHints.Adornments.singleton(Seq(true, false))
//  val adornedIncMainGP = Datalog.Pattern(None, "main_f", Seq(Datalog.Param("out", Datalog.TScalaInt)), Seq(Datalog.Body(Seq(
//    Datalog.Computed(Datalog.Var("lit"), Datalog.Evaluation(Seq(), Datalog.TScalaInt, Scala(q"() => 0"))),
//    Datalog.Call("inc_bf", Seq(Datalog.Var("lit"), Datalog.Var("out_0")), transitive = false, neg = false).addHint(MagicSetHints.Adornments.singleton(Seq(true, false)),
//    Datalog.Eq(Datalog.Var("out"), Datalog.Var("out_0"))
//  )))).addHint(MagicSetHints.Adornments.singleton(Seq(false)))
...
//    Datalog.Computed(Datalog.Var("eval_0"), Datalog.Evaluation(Seq(Datalog.Var("n") -> Datalog.TScalaInt, Datalog.Var("lit_1") -> Datalog.TScalaInt),
//      Datalog.TScalaInt, Scala(q"(left: Int, right: Int) => left - right"))),
//    Datalog.Call("fact_bf", Seq(Datalog.Var("eval_0"), Datalog.Var("out_0")), transitive = false, neg = false).addHint(MagicSetHints.Adornments.singleton(Seq(true, false))),
//    Datalog.Computed(Datalog.Var("eval_1"), Datalog.Evaluation(Seq(Datalog.Var("n") -> Datalog.TScalaInt, Datalog.Var("out_0") -> Datalog.TScalaInt),
//      Datalog.TScalaInt, Scala(q"(left: Int, right: Int) => left * right"))),
//    Datalog.Eq(Datalog.Var("out"), Datalog.Var("eval_1"))
//  )))).addHint(MagicSetHints.Adornments.singleton(Seq(true, false)))
...
//    Datalog.Computed(Datalog.Var("lit"), Datalog.Evaluation(Seq(), Datalog.TScalaInt, Scala(q"() => 3"))),
//    Datalog.Call("fact_bf", Seq(Datalog.Var("lit"), Datalog.Var("out_0")), transitive = false, neg = false).addHint(MagicSetHints.Adornments.singleton(Seq(true, false))),
//    Datalog.Eq(Datalog.Var("out"), Datalog.Var("out_0"))
//  )))).addHint(MagicSetHints.Adornments.singleton(Seq(false)))
...
//            Datalog.Path(Datalog.Var("link"), tNode, fromTLink, Datalog.Var("x"), tNode),
//            Datalog.Path(Datalog.Var("link"), tNode, toTLink, Datalog.Var("z"), tNode),
//            Datalog.Call("reachable_bb", Seq(Datalog.Var("z"), Datalog.Var("y")), transitive = false, neg = false).addHint(MagicSetHints.Adornments.singleton(Seq(true, true)))
//          )),
//        )
//      ).addHint(MagicSetHints.Adornments.singleton(Seq(true, true))),
...
//          )),
//        )
//      ).addHint(MagicSetHints.Adornments.singleton(Seq(true))),
...
//            Datalog.Call("reachable_bb", Seq(Datalog.Var("x"), Datalog.Var("y")), transitive = false, neg = true).addHint(MagicSetHints.Adornments.singleton(Seq(true, true))),
//          ))
//        )
//      ).addHint(MagicSetHints.Adornments.singleton(Seq(false, true))),
//      Datalog.Pattern(None, "main_ff", Seq(Datalog.Param("x", tNode), Datalog.Param("y", tNode)),
//        Seq(
//          Datalog.Body(Seq(
//            Datalog.HasType(Datalog.Var("y"), tNode),
//            Datalog.Eq(Datalog.Var("y"), Datalog.Constant(Datalog.IntLiteral(0))), // this is only temporary
//            Datalog.Call("unreachable_fb", Seq(Datalog.Var("x"), Datalog.Var("y")), transitive = false, neg = false).addHint(MagicSetHints.Adornments.singleton(Seq(false, true))),
//          ))
//        )
//      ).addHint(MagicSetHints.Adornments.singleton(Seq(false, false))),
//    ),
//    Seq())
//
