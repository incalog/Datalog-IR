  ...
  private final object GeneratedPQuery extends BasePQuery(PVisibility.PUBLIC) {
    ...
    override protected def doGetContainedBodies(): util.Set[PBody] = {
      val bodies: util.Set[PBody] = util.Set.of {
        ...
        new TypeConstraint(body, Tuples.staticArityFlatTupleOf(var_class, var_trg0), inca.runtime.index.LinkNodeKey(("inca.analyzedLangs.ClassDeclaration", "members")))
        new Equality(body, var_members, var_trg0)
        new TypeConstraint(body, Tuples.staticArityFlatTupleOf(var_trg1, var_members), inca.runtime.index.dynamic.ParentIndex.Key)
        ...
        new TypeConstraint(body, Tuples.staticArityFlatTupleOf(var_member, var_trg2), inca.runtime.index.LinkNodeKey(("inca.analyzedLangs.FieldDeclaration", "visibility")))
        new TypeConstraint(body, Tuples.flatTupleOf(var_trg2), inca.runtime.index.NodeTypeKey(truechange.SortType("inca.analyzedLangs.ProtectedVisibility")))
        body
      }
      bodies
    }
