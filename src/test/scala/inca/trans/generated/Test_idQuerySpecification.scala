...
object Test_idQuerySpecification {
  def instance(): Test_idQuerySpecification = LazyHolder.INSTANCE
  private final object LazyHolder {
    val INSTANCE: Test_idQuerySpecification = make()
    def make(): Test_idQuerySpecification = new Test_idQuerySpecification()
  }
