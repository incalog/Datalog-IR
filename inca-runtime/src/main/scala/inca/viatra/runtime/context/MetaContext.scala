...
import inca.viatra.runtime.index.{IndexKey, LinkListFirstKey, LinkListNextKey, LinkNodeKey, LinkPrimitiveKey, NamedRelationKey, NodeTypeKey, PrimitiveTypeKey, VirtualKey}
import inca.viatra.runtime.index.dynamic.ParentIndex
import inca.viatra.runtime.index.dynamic.ParentIndex.Key
import inca.viatra.runtime.index.virtual.SizeIndex
