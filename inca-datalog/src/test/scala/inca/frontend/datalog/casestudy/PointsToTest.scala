...
import inca.frontend.datalog.executor.DatalogExecutor.?
import inca.ir.execution.{Relation, Relation1, Relation2, Relation3, Relation4, RelationUpdateListener}
...
class PointsToTest extends AnyFunSuite:
  val pipeline = List()
  ...
  test("constant seq") {
    val code = FileUtil.readFileFromResource("datalog/casestudy/pointsto.dl")
